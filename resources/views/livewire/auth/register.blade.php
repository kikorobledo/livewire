<div
    ...
    <div class="relative ">
        ...
        <input wire:model="name" type="name" id="name" name="name" placeholder="name"
    ...
    <div class="relative mt-4">
        <label for="confirmpassword" class="text-base leading-7 text-blueGray-500">Password Confirmation</label>
        <input wire:model.lazy="confirmpassword" type="password" id="confirmpassword" name="confirmpassword" placeholder="password"
            class="@error('confirmpassword') border-red-300 @enderror w-full px-4 py-2 mt-2 text-base text-black transition duration-500 ease-in-out transform border border-gray-20 rounded-lg bg-blueGray-100 focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2">
    </div>
