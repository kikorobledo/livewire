...
use App\Http\Livewire\DataTable\WithCaheRows;
...
class Dashboard extends Component {
    ...
    use WithPerPagePagination, WithSorting, WithBulkActions, WithCaheRows;
    ...
    public function create(){
        ...
        $this->notify('Created successfully', 'success');
    ...
    public function getRowsQueryProperty(){
        ...
        $query = Transaction::when($this->filters['status'], fn($query, $status) => $query->where('status', $status))
